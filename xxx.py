...
def primiam():
  os.system("clear")
  baner= os.system("figlet -f slant BD SMS")
  baner = str(baner)
  baner = baner.replace("0","")
  logo=f"""\033[38;5;46m {baner}\033[1;37m

××××××××××××××××××××××××××××××××××××××××××××
\033[1;37m[\033[38;5;46m+\033[1;37m] DEVELOPER : BD SUJOY
\033[1;37m[\033[38;5;46m+\033[1;37m] GITHUB    : sujoy221133
\033[1;37m[\033[38;5;46m+\033[1;37m] VERSION   : 1.5
\033[1;37m[\033[38;5;46m+\033[1;37m] PROJECT   : SMS BOMBING 
\033[1;37m❲\033[38;5;46m+\033[1;37m❳ FACEBOOK  : RJ SUJOY RAJ
××××××××××××××××××××××××××××××××××××××××××××"""
  for i in logo:
    sys.stdout.write(i)
    sys.stdout.flush()
